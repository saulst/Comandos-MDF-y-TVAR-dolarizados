...
reporte_ecuador <- function(base,treshold,vector_variables,pais0){
  ...
  pa<-c(NA,NA,NA,NA,NA,NA)
  fitted<-rbind(pa, fitted)
...
resumen_ecuador3<-reporte_ecuador(base=base, 
                                  vector_variables = vector_variables,
                                  pais0 =  "Ecuador", 
                                  treshold=6)

plot(resumen_ecuador3$serie)
plot(resumen_ecuador3$impulsos[[5]])
impulso_ief_ecuador3<-resumen_ecuador3$impulsos[[6]]$data
impulso_ief_ecuador3<-split(impulso_ief_ecuador3, impulso_ief_ecuador3$Regime)

write.xlsx(impulso_ief_ecuador3, "Ecuador_impulso_ief3.xlsx")
plot(resumen_ecuador3$impulsos[[5]])
shock_gdp_ecu<-resumen_ecuador3$impulsos[[5]]$data
shock_gdp_ecu<-split(shock_gdp_ecu, shock_gdp_ecu$Regime)
write.xlsx(shock_gdp_ecu, "Ecuador_shock_gdp.xlsx")
